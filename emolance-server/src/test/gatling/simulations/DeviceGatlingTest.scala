...
class DeviceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Device entity")
        ...
        .repeat(2) {
            ...
            .put("/api/devices")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "sn":"SAMPLE_TEXT", "regTime":"2020-01-01T00:00:00.000Z", "lastUpdate":"2020-01-01T00:00:00.000Z", "status":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_device_url")))
            .pause(10)
            .repeat(5) {
