 ...
 */
public class EmolanceAuthenticator extends AbstractAccountAuthenticator {

    private Context context;

    public EmolanceAuthenticator(Context context) {
        super(context);
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType, String authTokenType, String[] requiredFeatures, Bundle options) throws NetworkErrorException {
        Log.i("TEST", "addAccount in Authenticator!");
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse accountAuthenticatorResponse,
        ...
        Log.i("TEST", "GetAuthToken called!");
        ...
        if (TextUtils.isEmpty(authToken)) {
            ...
            if (password != null) {
                authToken = "dummy-token"; //sServerAuthenticate.userSignIn(account.name, password, authTokenType);
            }
        }
